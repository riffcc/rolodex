...
impl ChatWidget {
    ...
    pub(super) fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Help => {
                self.add_info_message(
                    "Rolodex quick help\n\n\
                     Rolodex keeps Codex's chat flow and adds project-aware navigation, \
                     controller support, and faster ways to juggle multiple sessions.\n\n\
                     /tasks opens the Palace-native task picker."
                        .to_string(),
                    None,
                );
            }
    ...
    fn queued_command_drain_result(&self, cmd: SlashCommand) -> QueueDrain {
        ...
        match cmd {
            ...
            SlashCommand::Tasks => QueueDrain::Stop,
        }
    }
