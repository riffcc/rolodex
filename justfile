...
rolodex *args:
    cargo run --bin rolodex -- {args}

# Compatibility recipe for upstream documentation and muscle memory.
codex *args:
    cargo run --bin rolodex -- {args}

# `rolodex exec`
exec *args:
    cargo run --bin rolodex -- exec {args}
...
app-server-test-client *args:
    ...
    cargo run -p codex-app-server-test-client -- --codex-bin ./target/debug/rolodex {args}
